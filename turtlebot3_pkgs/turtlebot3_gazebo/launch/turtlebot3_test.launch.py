...
def generate_launch_description():
    ...
    pkg_rviz = get_package_share_directory('rviz2')  # Path to RViz package
    ...
    rviz_cmd = Node(
        ...
        name='rviz2',
        output='screen',
        arguments=['-d', rviz_config_file]  # RViz config file
    )
    ...
    ld.add_action(rviz_cmd)  # Add RViz launch command
